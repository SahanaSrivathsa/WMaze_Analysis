...
def main(group, fig_no):
    ...
    data_denom  = pd.read_csv(dir +'outbound'+ group + 'Denom.csv') # csv of total trials for each day
    data_numAll = pd.read_csv(dir +'outbound'+ group + 'Num.csv')  # correct per day
